...
namespace BookStoreApp.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            logger.LogInformation("Issuer: {Issuer}, Audience: {Audience}, Key: {Key}", configuration["JwtSettings:Issuer"], configuration["JwtSettings:Audience"], configuration["JwtSettings:Key"]);

            var configKey = configuration["JwtSettings:Key"];
            configKey ??= "";
